...
import { Position, Velocity, applyVelocityToPosition, isCollided } from '../pages/api/dinoGame/physics';
import { Character, CharacterMeta, CharacterAllocator, AllocatorCharacterArray } from '../pages/api/dinoGame/character';
// @ts-ignore
import { dino_layout, stone_layout, themes, cloud_layout, pit_layout, bird_layout, cactus_layout, retry_layout, star_layout } from '../pages/api/dinoGame/layouts';
...
const DinoGame = () => {
  ...
  return <canvas ref={canvasRef} id="board" />;
};
