const { applyVelocityToPosition } = require("./physics");

export class CharacterMeta {
  private _movement_delay: any;
  private _movements_array: any;
...
export class Character {
  private _character_meta: any;
  private _tick_counter: number;
  private _movement_delay_counter: number;
...
export class CharacterAllocator {
  private _allocator_character_array: any;
  private _min_gap: any;
  private _gap_random_max: any;
  private _pending_gap: number;
